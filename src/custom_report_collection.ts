import type { WorkflowReport } from "./analyzer/analyzer.ts";
import type { CustomReportArtifact } from "./client/artifact.ts";
...
export const aggregateCustomReportArtifacts = (
  customReportArtifactsList: CustomReportArtifact[],
) => {
...
export const createCustomReportCollection = async (
  workflowReport: WorkflowReport,
  customReportArtifacts: CustomReportArtifact,
): Promise<CustomReportCollection> => {
...
export class CustomReportCollection {
  customReports: Map<string, CustomReport[]> = new Map<
    string,
    CustomReport[]
  >();
